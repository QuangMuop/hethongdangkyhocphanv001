...
-- ----------------------------
-- Procedure structure for Student_select
-- ----------------------------
DROP PROCEDURE IF EXISTS `Student_select`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Student_select`(code varchar(50))
Begin
select FullName, Class from dangkyhocphan.Student
where MSSV=code;
End;;
DELIMITER ;
...
INSERT INTO `rule` VALUES ('1', '25', '15', '18', '40', '120', '30', '5', '25', '50');
INSERT INTO `student` VALUES ('Nguyễn Đức Lê', '07252190', '1989-10-23', 'CNPM02', 'ducle133@yahoo.com', '01211213478', 'Quận 1, Tp.HCm', 'Tp.HCm', '1', '2');
INSERT INTO `student` VALUES ('Hoàng Nam Hải', '07520106', '1989-01-01', 'CNPM02', 'namhai@gmail.com', '0978345095', 'Quận 12, Tp.HCM', 'Tỉnh Lâm Đồng', '1', '2');
INSERT INTO `student` VALUES ('Nguyễn Văn Lộc', '07520210', '1989-12-12', 'CNPM02', 'nguyenloc.uit@gmail.com', '01683452346', 'Tân Bình, Tp.HCM', 'Tỉnh Ninh Bình', '1', '2');
INSERT INTO `student` VALUES ('Nguyễn Trung Thành', '07520319', '1987-02-08', 'CNPM02', 'thanhnt28@gmail.com', '0989432371', '9/32 khu phố 6, P.Linh Trung, Q.Thủ Đức, Tp.HCm', 'Xuân Liên-Nghi Xuân-Hà Tĩnh', '1', '2');
